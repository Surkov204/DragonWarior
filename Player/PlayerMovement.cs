...
public class PlayerMoverment : MonoBehaviour
{
    ...
    [SerializeField] private float coolDownBoosting;
    private float _dashTime;
    private float _coolDownBoosting = Mathf.Infinity;
    ...
    private void Update()
    {
        ...
        {
            if (Input.GetKey(KeyCode.LeftControl) && _dashTime <= 0 && isDashing == false && _coolDownBoosting > coolDownBoosting)
            {
